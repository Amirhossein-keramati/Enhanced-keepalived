...
url = ''
domain = ''
# get information about available services(Currently, it supports two DNS, WEB services)
...
# gathering device information in a central point
...
# create a virtual NIC on the device to accept traffic sent to the virtual IP address
def vNIC():
    global virtual_ip
...
# function to send hello message in 5s interval 
...
# function to sniff hello messages
...
# function to detect the AVG device
def AVG_selection():
